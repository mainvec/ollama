...
var (
	...
	// NoDebugHTTPPprof disables pprof for the HTTP server
	NoDebugHTTPPprof = Bool("OLLAMA_NODEBUG_HTTP_PPROF")
)
...
func AsMap() map[string]EnvVar {
	ret := map[string]EnvVar{
		...
		"OLLAMA_NODEBUG_HTTP_PPROF": {"OLLAMA_NODEBUG_HTTP_PPROF", NoDebugHTTPPprof(), "Disable pprof for HTTP server"},
